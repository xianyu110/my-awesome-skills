...
description: 使用 Gemini 图像模型生成图片，支持白板图、Logo设计、社交媒体配图、概念图和教程配图。用于用户要求生成图片、白板图、Logo、社交媒体视觉图时。
metadata: {"openclaw":{"skillKey":"bananapro-image-gen","primaryEnv":"NEXTAI_API_KEY","emoji":"🍌"}}
---
